...
roaster.hiberante.defaultPU.log.session_metrics=true
roaster.hiberante.defaultPU.log.jdbc_warnings=true
roaster.hiberante.defaultPU.log.generate_statistics=true
----
