...
public class RestZephyrService {
    ...
    @Inject
    @RestClient
    private JiraV3RestClient jiraV3Client;
     ...
     */
    public void postResult(ZephyrExecution execution) {
    ...
    public String getAccountId() {
        return accountIdsByUserName.computeIfAbsent(serverConfig.getUserName(), k -> jiraV3Client.getSelf().getAccountId());
    }
