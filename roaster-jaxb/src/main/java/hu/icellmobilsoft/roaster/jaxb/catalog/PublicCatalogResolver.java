...
import hu.icellmobilsoft.coffee.rest.validation.catalog.CatalogLsInputImpl;
import hu.icellmobilsoft.coffee.rest.validation.xml.utils.IXsdResourceResolver;
import hu.icellmobilsoft.coffee.se.logging.Logger;

/**
 * Implements CatalogResolver. <br>
 * This class implements a SAX EntityResolver, StAX XMLResolver, Schema Validation LSResourceResolver and Transform URIResolver. See
 * {@link javax.xml.catalog.Util} {@link javax.xml.catalog.CatalogResolverImpl}
 *
...
public class PublicCatalogResolver implements LSResourceResolver, IXsdResourceResolver {
    private final Logger log = Logger.getLogger(PublicCatalogResolver.class);

    private final Catalog catalog;

    /**
     * Default constructor with {@link ConfiguredCatalogFactory#createCatalog()} as the catalog.
     */
    public PublicCatalogResolver() {
        this(ConfiguredCatalogFactory.createCatalog());
    }

    /**
     * Constructor with the given catalog.
     * 
     * @param catalog
     *            catalog to be used.
     */
    public PublicCatalogResolver(Catalog catalog) {
