 ...
 * General pattern is "{@code roaster.redis.${configKey}.${setting}}
 *
 * ie.:
 *
 * <pre>
 ...
 * @since 2.7.0
 */
public class RedisConfig implements hu.icellmobilsoft.coffee.module.redis.config.RedisConfig {

    /**
     * Constant <code>REDIS_PREFIX="roaster.redis"</code>
     */
    public static final String REDIS_PREFIX = "roaster.redis";
    ...
    /**
     * Creates a new {@link RedisConfig} instance with the given {@code configKey}.
     * 
     * @param configKey
     *            the configKey to use
     */
    public RedisConfig(String configKey) {
